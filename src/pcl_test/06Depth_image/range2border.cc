...
main (int argc, char** argv)
{
    ...
    if (!pcd_filename_indices.empty ())
    {
        ...
        printf("current process file's path: %s, getcwd: %s\n",
            ...
            !ptr1.empty() ? ptr1.c_str() : "unknown");//"/home/d/githubPro/casadi_test/build/src/pcl_test/table_scene_mug_stereo_textured.pcd"
        ...
        pcl::io::savePCDFile(pcl::getFilenameWithoutExtension (filename)+"_far_ranges.pcd",point_cloud);
