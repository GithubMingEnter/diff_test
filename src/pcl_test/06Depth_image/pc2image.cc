...
// pcl::io::loadPCDFile("./data/table_scene_lms400_downsampled.pcd", pointCloud);
    ...
    Eigen::Affine3f sensorPose = (Eigen::Affine3f)Eigen::Translation3f(0.0,0.0,0.0); // 采集位置
    ...
    */
    ...
    // 添加深度图点云
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointWithRange> range_image_color_handler(range_image_ptr,0,0,100);//r,g,b
